...
//            get user from the session
            ...
            if (ans) {
                ...
                String oldPath = request.getServletContext().getRealPath("/") + "pics" + File.separator + oldFileName;
                ...
                if (Helper.saveFile(part.getInputStream(), path)) {
                    ...
                    Message msg = new Message("Profile not updated successfully ", "error", "alert-danger");
                    s.setAttribute("msg", msg);
                    response.sendRedirect("profile.jsp");
                }
